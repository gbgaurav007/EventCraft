  ...
  return (
    <div className="bg-white shadow rounded-lg p-4">
      <div className="flex space-x-6">
        <img src={event.images[0]} alt={event.name} className="w-40 h-40 md:w-48 md:h-48 object-cover rounded" />
      ...
      <div className="flex justify-between md:hidden block">
        <p className="text-blue-600">{event.tickets} ticket(s) booked</p>
        <div className="flex cursor-pointer hover:text-gray-700 hover:scale-[1.05]" onClick={() => handleViewDetails(event)}>
          <p>View Details</p><IoIosArrowForward className="text-md mt-1 ml-1" />
        </div>
      </div>
    </div>
